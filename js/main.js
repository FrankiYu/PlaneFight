...
if (window.innerWidth)
    ...
    if (document.documentElement && document.documentElement.clientHeight && document.documentElement.clientWidth) {
        ...
        var startDiv = document.getElementById('startdiv');
        var mainDiv = document.getElementById('maindiv');
        startDiv.style.width = winWidth + 'px';
        mainDiv.style.width = winWidth + 'px';
        startDiv.style.height = winHeight + 'px';
        mainDiv.style.height = winHeight + 'px';
...
移动行为
    ...
    this.planmove=function(){
        if(scores<=50000){
            this.imagenode.style.top=this.imagenode.offsetTop+this.plansudu+boss+"px";
        }
        else if(scores>50000&&scores<=100000){
            this.imagenode.style.top=this.imagenode.offsetTop+this.plansudu+boss+1+"px";
        }
        else if(scores>100000&&scores<=150000){
            this.imagenode.style.top=this.imagenode.offsetTop+this.plansudu+boss+2+"px";
        }
        else if(scores>150000&&scores<=200000){
            this.imagenode.style.top=this.imagenode.offsetTop+this.plansudu+boss+3+"px";
        }
        else if(scores>200000&&scores<=300000){
            this.imagenode.style.top=this.imagenode.offsetTop+this.plansudu+boss+4+"px";
        }
        else{
            this.imagenode.style.top=this.imagenode.offsetTop+this.plansudu+boss+5+"px";
        }
    }
    this.init=function(){
        this.imagenode=document.createElement("img");
        this.imagenode.style.left=this.planX - 300 +"px";
...
function ourplan(X,Y){
    ...
    plan.call(this,1,X,Y,66,80,0,winWidth,0,"image/本方飞机爆炸.gif",imagesrc);
...
var bianjie=function(){
    ...
    if(bodyobjX<0||bodyobjX>winWidth||bodyobjY<0||bodyobjY>winHeight){
        if(document.removeEventListener){
            mainDiv.removeEventListener("mousemove",yidong,true);
        }
        else if(document.detachEvent){
...
function start(){
    ...
    if(mark==20){
        ...
        //中飞机
        if(mark1%5==0){
            enemys.push(new enemy(6,winWidth+280,274,46,60,5000,360,random(1,3),"image/中飞机爆炸.gif","image/enemy3_fly_1.png"));
        }
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12,winWidth+380,210,110,164,30000,540,1,"image/大飞机爆炸.gif","image/enemy2_fly_1.png"));
            mark1=0;
        }
        //小飞机
        else{
            enemys.push(new enemy(1,winWidth+420,286,34,24,1000,360,random(1,4),"image/小飞机爆炸.gif","image/enemy1_fly_1.png"));
        }
        mark=0;
    }
